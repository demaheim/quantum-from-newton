"""Harmonic oscillator, second excited state (n = 2)."""
...
pol = list_polarities(num_companions, flips=[24, 36])  # two walls; domains of 24 / 12 / 24

print(f"relaxing {num_companions} companions to oscillator state n = 2 ...", flush=True)
chain = integrate(
...
print(
    ...
    save(
        ...
        P=P / P.max(),
        x_ref=x_ref,
        P_ref=oscillator.eigenstate_density(2, x_ref),
    ),
)
