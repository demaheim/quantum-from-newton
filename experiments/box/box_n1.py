"""Particle in a box, ground state (n = 1)."""
...
pol = list_polarities(num_companions)  # no domain wall

print(f"relaxing {num_companions} companions to box state n = 1 ...", flush=True)
chain = integrate(
...
print(
    ...
    save(
        ...
        P=P / P.max(),
        x_ref=x_ref,
        P_ref=box.eigenstate_density(1, x_ref),
    ),
)
