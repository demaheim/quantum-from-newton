"""Particle in a box, second excited state (n = 3)."""
...
pol = list_polarities(num_companions, flips=[20, 40])  # two walls, three domains of 20

print(f"relaxing {num_companions} companions to box state n = 3 ...", flush=True)
chain = integrate(
...
print(
    ...
    save(
        ...
        P=P / P.max(),
        x_ref=x_ref,
        P_ref=box.eigenstate_density(3, x_ref),
    ),
)
